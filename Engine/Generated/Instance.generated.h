<<<<<<< HEAD
//Autogenerated at 2025-12-12 13:17:01.724668
=======
//Autogenerated at 2025-12-11 22:48:27.271350
...
namespace Reflection {
	...
	inline static Class reflected_Instance = {
		...
		152245926312174492ULL,
		{
			...
			{ "Id", "EngineUUID", 9675371895780238136ULL, PropFlags::Hidden | PropFlags::ReadOnly | PropFlags::Replicated, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr },
			{ "Archivable", "bool", 14317038659104216526ULL, PropFlags::Replicated, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr },
			{ "Name", "std::string", 15240050715179114350ULL, PropFlags::Replicated, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr },
			{ "Parent", "Instance*", 14850803764360279445ULL, PropFlags::Replicated, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr },
			{ "Children", "std::vector<Instance*>", 9730800845107737082ULL, PropFlags::ReadOnly, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr }
		},
		{
			//events
			{ "PropertyChanged", {{ "uint64_t", "???" }}, 7827212715229259961ULL, AccessLevel::Public, Lua::StateContext::Client },
			{ "LuaPropertyChanged", {{ "std::string", "PropName" }}, 632871268461416663ULL, AccessLevel::Public, Lua::StateContext::Client },
			{ "ChildAdded", {{ "Instance*", "Child" }}, 12382991221415885166ULL, AccessLevel::Public, Lua::StateContext::Client },
			{ "ChildRemoved", {{ "Instance*", "Child" }}, 12241140569974167456ULL, AccessLevel::Public, Lua::StateContext::Client },
			{ "DescendantAdded", {{ "Instance*", "Child" }, { "Instance*", "Parent" }}, 3535955318022864309ULL, AccessLevel::Public, Lua::StateContext::Client },
			{ "DescendantRemoved", {{ "Instance*", "Child" }, { "Instance*", "Parent" }}, 17063255535271212331ULL, AccessLevel::Public, Lua::StateContext::Client }
		},
		{
			//methods
...
namespace Reflection { \
 ...
 \
	inline void register_Instance() { \
		...
		Reflection::GetRegistry().classesById.insert({ 152245926312174492ULL, &Reflection::reflected_Instance }); \
