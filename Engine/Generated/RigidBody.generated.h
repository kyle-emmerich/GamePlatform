<<<<<<< HEAD
//Autogenerated at 2025-12-12 13:17:01.768623
=======
//Autogenerated at 2025-12-11 22:48:27.724301
...
namespace Reflection {
	...
	inline static Class reflected_RigidBody = {
		...
		"RigidBody",
		//Class hash id
		15834844444784614414ULL,
		{
			//	Name, Type, Id, Flags, TypeFlags, Setter, Getter
			{ "Properties", "PhysicalProperties", 16562598759682906392ULL, DefaultPropFlags, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr },
			{ "Inertia", "Math::Transform<double>", 10662476686257125261ULL, PropFlags::ReadOnly, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr },
			{ "Velocity", "Math::Vector3<double>", 1318731205920430278ULL, DefaultPropFlags, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr },
			{ "AngularVelocity", "Math::Vector3<double>", 15020630643522006634ULL, DefaultPropFlags, PropTypeFlags::None, AccessLevel::Public, Lua::StateContext::Client, nullptr, nullptr }
		},
		{
			//events
...
namespace Reflection { \
 ...
 \
	inline void register_RigidBody() { \
		...
		Reflection::GetRegistry().classesById.insert({ 15834844444784614414ULL, &Reflection::reflected_RigidBody }); \
