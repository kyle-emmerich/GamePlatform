//Autogenerated at 2025-12-10 14:05:28.227079
#pragma once
#include <typeinfo>
#include <memory>
#include <stdexcept>
...
namespace Reflection { \
	...
	inline void wrap_RigidBody_SetVelocity(void* obj, void* value) { reinterpret_cast<RigidBody*>(obj)->Velocity = *reinterpret_cast<Math::Vector3<double>*>(value); } \
	...
	inline void wrap_RigidBody_SetAngularVelocity(void* obj, void* value) { reinterpret_cast<RigidBody*>(obj)->AngularVelocity = *reinterpret_cast<Math::Vector3<double>*>(value); } \
